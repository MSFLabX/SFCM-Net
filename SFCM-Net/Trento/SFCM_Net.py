...
class CB(nn.Module):
    def __init__(self, l):
        ...
        self.point_conv1 = nn.Conv2d(l, 32, kernel_size=1)
        self.norm2 = nn.LayerNorm(32)
        self.point_conv2 = nn.Conv2d(32, 64, kernel_size=1)
...
class SFCE(nn.Module):
    def __init__(self, c, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False):
        ...
        self.extra_conv = nn.Conv2d(c, c, kernel_size=3, padding=1, groups=c,
                                    bias=True) if extra_depth_wise else nn.Identity()
...
class SFCM(nn.Module):
    def __init__(self, l1, l2, num_classes):
        ...
        dim = 64
        self.SFCE11 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
        self.SFCE12 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
        self.SFCE13 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
        self.SFCE21 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
        self.SFCE22 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
        self.SFCE23 = SFCE(32, DW_Expand=2, dilations=(1, 2), extra_depth_wise=False)
