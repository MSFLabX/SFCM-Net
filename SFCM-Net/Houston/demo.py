...
parser.add_argument('--dataset', choices=['Muufl', 'Trento', 'Houston', 'Augsburg'], default='Houston',
                    help='dataset to use')
parser.add_argument('--num_classes', choices=[11, 6, 15, 7], default=15, help='number of classes')
