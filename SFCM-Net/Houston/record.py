...
def record_output(LabelPath, oa_ae, aa_ae, kappa_ae, element_acc_ae, training_time_ae,  path):
    f = open(path, 'a')
    f.write(LabelPath)
    ...
    f.write(sentence2)
    sentence3 = 'mean_OA ± std_OA is: ' + str(round(np.mean(oa_ae),16)) + ' +- ' + str(np.std(oa_ae)) + '\n'
    f.write(sentence3)
    sentence4 = 'mean_AA ± std_AA is: ' + str(round(np.mean(aa_ae),16)) + ' +- ' + str(np.std(aa_ae)) + '\n'
    f.write(sentence4)
    sentence5 = 'mean_KAPPA ± std_KAPPA is: ' + str(round(np.mean(kappa_ae),16)) + ' +- ' + str(np.std(kappa_ae)) + '\n' + '\n'
    f.write(sentence5)
